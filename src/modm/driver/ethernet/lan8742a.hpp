...
struct Lan8742a
{
	...
	static constexpr uint16_t StatusAutoNegotiationDone = 0x1000;
	static constexpr uint16_t StatusSpeedMask = 0x001c;
	static constexpr uint16_t Status10HalfDuplex = 0x0004;
	static constexpr uint16_t Status10FullDuplex = 0x0014;
	static constexpr uint16_t Status100HalfDuplex = 0x0008;
	static constexpr uint16_t Status100FullDuplex = 0x0018;
};
